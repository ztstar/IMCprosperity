...
class Trader:
    ...
    def run(self, state: TradingState) -> Dict[str, List[Order]]:
        ...
        midprice = {"PICNIC_BASKET2": 0, "CROISSANTS": 0, "JAMS": 0}
        position = {"PICNIC_BASKET2": 0, "CROISSANTS": 0, "JAMS": 0}
        ...
        if not miss_information:
            print(f"midprice: {midprice["PICNIC_BASKET2"], midprice["CROISSANTS"], midprice['JAMS']}")
            diff = midprice["PICNIC_BASKET2"] - b1*midprice["CROISSANTS"] - b2*midprice["JAMS"] - c
